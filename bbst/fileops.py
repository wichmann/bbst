...
def write_moodle_file(teacher_list, output_file='Moodle.csv'):
    ...
    cohort1;lastname;firstname;username;password;email;sysrole1;profile_field_source;deleted
    Kollegium;Müller;Kirsten;kirsten.mueller;12345678;kirsten.mueller@bbs-brinkstrasse.net;coursecreator;iServ;0 
    """
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        output_file_writer.writerow(('cohort1', 'lastname', 'firstname', 'username', 'password',
                                     'email', 'sysrole1', 'profile_field_source', 'auth', 'deleted'))
        for teacher in teacher_list:
            long_username = generate_long_username(teacher.first_name, teacher.last_name)
            # use long username as would be generated by iServ and create new save dummy passwort that will
            # never be used because these users are for SSO with iServ only
            output_file_writer.writerow(('Kollegium', teacher.last_name, teacher.first_name, long_username,
                                         _generate_password(), f'{long_username}@bbs-brinkstrasse.net',
                                         'coursecreator', 'iServ', 'oauth2', '1' if teacher.deleted else '0'))
            count += 1
